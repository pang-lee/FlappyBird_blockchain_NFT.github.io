...
gameLoop();
 ...
 function gameLoop()
 { 
    document.getElementById('token').innerText = 'Earn Token: ' + localStorage.getItem("best")

    // if(Number(localStorage.getItem("best")) > 5){
    //  document.getElementById('nft').innerText = 'Earn NFT: ' + localStorage.getItem("nft")
    // }
